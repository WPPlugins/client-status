...
= 1.4 =
- Changed plugin code to be object-oriented
- Fix for client info not closing when clicked while Expand Client Details setting was Yes.
- Added hooks for extending the plugin
- Added new file hooks.sample.php to show plugin developers the base code for ading new functionality
- Added username and password to client edit screen for saving info and allowing remote updating from dashboard.
- Must enable XML-RPC on client sites to allow remote updating.
